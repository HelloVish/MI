        ...
        "properties": {
            "deepgram": {
                ...
                "properties": {
                    ...
                    "callback": {
                        "type": "string",
                        "description": "The URL to send the transcriptions to. If used, the transcriptions will be sent directly from Deepgram to your server so you will not be able to access them via the Meet Insights API. See here for details: https://developers.deepgram.com/docs/callback",
                    },
                },
                "additionalProperties": False,
            },
...
@extend_schema_serializer(
    examples=[
        OpenApiExample(
            "Recording Upload",
            value={
                "url": "https://meet-insight-short-term-storage-production.s3.amazonaws.com/e4da3b7fbbce2345d7772b0674a318d5.mp4?...",
